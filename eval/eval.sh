...
datasets="${aime2025_test_path},${aime2024_test_path},${math500_test_path},${math_test_path},${amc23_test_path},${gpqa_test_path}"
datasets="${aime2025_test_path},${aime2024_test_path},${math500_test_path},${amc23_test_path},${gpqa_test_path}"
# datasets="${amc23_test_path}"
# datasets="${math500_test_path}"
