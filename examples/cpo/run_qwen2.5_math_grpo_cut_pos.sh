...
export OPENAI_API_KEY="afdfd0b8bacc7e7c86b5e59fa6fc027b" # lasa: afdfd0b8bacc7e7c86b5e59fa6fc027b. https://idealab.alibaba-inc.com/api/openai/v1 decision: 97967a028f53442f9b54099c1f2e1592 http://39.96.211.155:8000/proxy/api/openai/v1/
...
math_train_path=/mnt/workspace/workgroup_dev/weiwen/cut2/data/math_nsr/train_math.parquet
math_test_path=/mnt/workspace/workgroup_dev/weiwen/cut2/data/math_nsr/test_math.parquet
aime2025_test_path=/mnt/workspace/workgroup_dev/weiwen/cut2/data/math_nsr/test_aime2025.parquet
amc23_test_path=/mnt/workspace/workgroup_dev/weiwen/cut2/data/math_nsr/test_amc23.parquet
project_name='math_rl'
exp_name='Qwen2.5-math-7B_math-vllm-n8_1009_grpo_cut_goldshotasjudge_pos_dynamic_mlflow'
...
if [ "$RANK" -eq 0 ]; then
    ...
    python -m verl.trainer.main_ppo \
        ...
        actor_rollout_ref.model.path=/mnt/workspace/workgroup_dev/weiwen/models/Qwen2.5-Math-7B  \
        +algorithm.gold_as_hint=True \
        +algorithm.cpo_lambda=2 \
        +algorithm.pos_alpha=0.2 \
        +algorithm.neg_alpha=0 \
