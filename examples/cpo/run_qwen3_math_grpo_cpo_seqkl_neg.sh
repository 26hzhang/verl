...
math_train_path=./data/math_train/train_math.parquet
...
project_name='math_rl_qwen3-4b'
exp_name='Qwen3-4B_math-vllm-n8_1106_cpo_neg0.5_seqkl_mlflow'
CKPTS_DIR=../verl_checkpoints/${project_name}/${exp_name}
