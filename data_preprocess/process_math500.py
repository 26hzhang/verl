...
if __name__ == "__main__":
    ...
    dataset_gpqa = datasets.load_dataset("data/raw/math500", trust_remote_code=True)['test']
    ...
    test_dataset_gpqa = dataset_gpqa.map(function=make_map_fn("test", "math500"), with_indices=True)

    local_dir = args.local_dir
    hdfs_dir = args.hdfs_dir

    test_dataset_gpqa.to_parquet(os.path.join(local_dir, "test_math500.parquet"))
